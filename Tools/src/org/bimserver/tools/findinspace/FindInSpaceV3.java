...
public class FindInSpaceV3 {
	...
	private void start() {
		jsonOutput = objectMapper.createObjectNode();
...
//														Matrix.multiplyMV(result, 0, spaceMatrix, 0, new double[] { coords.get(0), coords.get(1), 0, 1 }, 0);
												...
												// TODO This is not doing any rotation on the space, which is necessary when the direction values are non zero
